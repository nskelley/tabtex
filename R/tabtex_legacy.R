#' Legacy version of tabtex (deprecated)
#'
#' @description
#' \lifecycle{deprecated}
#' 
#' This is the legacy implementation of `tabtex()`. It is deprecated and will be
#' removed in a future version. Use `tabtex()` instead.
#'
...
#'
#' @details
#' `tabtex_legacy()` contains the original implementation of `tabtex()`. This
#' function is deprecated as of version 0.0.7 and will be removed in a future
#' version. The new `tabtex()` function provides an improved implementation.
#'
#' @keywords internal
#' @export
tabtex_legacy <- function(.data, 
                   out,
                   title, 
                   label,
                   width = "0.8\\linewidth",
  ...
  .Deprecated("tabtex", package = "tabtex", msg = "tabtex_legacy() is deprecated. Use tabtex() instead.")
